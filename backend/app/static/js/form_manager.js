function handleFormSubmit(event, formId, apiUrl, successMessage, method = "POST", callbackName = null, callbackRedirect = '') {
    ...
    axiosCall
        .then(response => {
            ...
            if (callbackName && typeof window[callbackName] === "function") {
                window[callbackName](response, callbackRedirect); // Run callback function
            }
        })
        .catch(error => {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("form[data-url]").forEach(form => {
        ...
        const callbackName = form.dataset.callback || null;
        const callbackRedirect = form.dataset.callbackRedirect || '';
